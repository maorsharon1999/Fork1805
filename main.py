...
def main() -> None:
    ...
    if sev_local and "y_true" in sev_local:
        viz.plot_severity_confusion_matrix(
            sev_local["y_true"], sev_local["y_pred"],
            labels=sev_local["labels"],
            score_col="local_score",
            filename="severity_cm_local.png",
        )

    if sev_global and "y_true" in sev_global:
        viz.plot_severity_confusion_matrix(
            sev_global["y_true"], sev_global["y_pred"],
            labels=sev_global["labels"],
            score_col="global_score",
            filename="severity_cm_global.png",
        )
